...
case : mention.send ("naderfuad7@gmail.com:nn123456"); break;  
case 1: mention.send ("qumberali1@gmail.com:moneyrocks1"); break;  
case 1: mention.send ("nassemom@gmail.com:omom7070"); break;  
case 1: mention.send ("pelael87@gmail.com:nare2015"); break;  
case 1: mention.send ("matyy102@gmail.com:indiana102"); break;
case 1: mention.send ("gabriel.jacy@gmail.com:gabriel26554368"); break;
case 1: mention.send ("alejandromztjr@gmail.com:chivas123"); break; 
case 1: mention.send ("giovanniromeo251@gmail.com:giovivale99"); break;  
case 1: mention.send ("burkiemartin29@gmail.com:warrior36"); break;  
                }
            if (mention == null) return; 
            message.delete();
            mentionMessage = message.content.slice (8)
